...
print(
    "Ingredient:", ingredient.name, "| Quantity:", ingredient.quantity, ingredient.unit
)

# Test creating a MealPlan
meal_plan = SimpleFactory.create_meal_plan(
    1, "Weekly Plan", date(2025, 4, 18), date(2025, 4, 25)
)
print(
    "Meal Plan:",
    meal_plan.title,
