...
class RepositoryFactory:
    ...
    @classmethod
    def get_repository(
        cls, entity_type: str, storage_type: str = "memory"
    ) -> MealPlanRepository | UserRepository:
        """
...
_STORAGE_TYPES = {
    "memory": {"meal_plan": InMemoryMealPlanRepository, "user": InMemoryUserRepository},
